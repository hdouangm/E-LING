...
public class PatientSetup {
  ...
  private void createData() {
      ...
      repository.save(new Patient(null, new DMP("19614"), new DonneesSociales("Bale", "Nelson", "28 Bryantwood Rd", "Londres", "N7 7BE", "United Kingdom", "11-23-1985", "M"), medecin));
      ...
      repository.save(new Patient(null, new DMP("19616"), new DonneesSociales("Werner", "Thomas", "Hanauer Str. 46", "Munich", "80992", "Germany", "02-20-1965", "M"), medecin));
