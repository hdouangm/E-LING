...
public class CompteAphpSetup {
    ...
    private void createData() {
       ...
       repository.save(new CompteAphp("Robert@gmail.com", "la","FR",new Employe(null, null, new DonneesSociales("Petit","Robert",null,null,null,null,null,null), 0,null),"qopic6kffqk2lgnjtti78ud1go@group.calendar.google.com"));
        
       repository.save(new CompteAphp("Hugo@gmail.com", "la","FR",new Employe(null, null, new DonneesSociales("Douangmala","Hugo",null,null,null,null,null,null), 1,null),"qopic6kffqk2lgnjtti78ud1go@group.calendar.google.com"));
       repository.save(new CompteAphp("Serge@gmail.com", "la","FR",new Employe(null, null, new DonneesSociales("Durand","Serge",null,null,null,null,null,null), 1,null),"qopic6kffqk2lgnjtti78ud1go@group.calendar.google.com"));
    
       repository.save(new CompteAphp("Cristiano@gmail.com", "la","FR",new Employe(null, null, new DonneesSociales("Dos Santos","Cristiano",null,null,null,null,null,null), 2,null),"qopic6kffqk2lgnjtti78ud1go@group.calendar.google.com"));
