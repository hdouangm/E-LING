...
public class DemandeInterventionRestService {
    ...
    @Path("/Search/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getDemandeIntervention(@PathParam("id") int id) {
    ...
    public Response createDemandeIntervention(DemandeIntervention d_intervention) {
        ...
        URI compteUri = uriInfo.getBaseUriBuilder().path(DemandeInterventionRestService.class).path(Integer.toString(d_intervention.getId())).build();
    ...
    @Path("/Update")
    @Produces({ MediaType.APPLICATION_JSON})
    public int updateDemandeIntervention(DemandeIntervention d_intervention) {
    ...
    public Response deleteDemandeIntervention(@PathParam("id") int id) {
        try {
